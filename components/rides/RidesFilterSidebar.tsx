...
export default function RidesFilterSidebar({
  ...
  return (
    <div className={`w-full md:w-80 md:flex-shrink-0 ${className}`}>
      <div className="bg-white rounded-2xl shadow-xl p-4 md:p-6 md:sticky md:top-8 mx-auto max-w-md md:max-w-none">
        <h2 className="text-xl font-bold text-gray-900 mb-6">Filters</h2>
