              ...
              <div className="flex space-x-3">
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 24 24"
                  >
                    <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.621 5.367 11.988 11.988 11.988s11.987-5.367 11.987-11.988C24.004 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.323-1.297C4.198 14.895 3.708 13.744 3.708 12.447s.49-2.448 1.297-3.323C5.832 8.302 6.983 7.812 8.28 7.812s2.448.49 3.323 1.297c.827.876 1.317 2.027 1.317 3.324s-.49 2.448-1.297 3.323c-.876.827-2.027 1.317-3.324 1.317zm7.439 0c-1.297 0-2.448-.49-3.323-1.297-.827-.876-1.317-2.027-1.317-3.324s.49-2.448 1.297-3.323c.876-.827 2.027-1.317 3.324-1.317s2.448.49 3.323 1.297c.827.876 1.317 2.027 1.317 3.324s-.49 2.448-1.297 3.323c-.876.827-2.027 1.317-3.324 1.317z" />
                  </svg>
                </a>
                <a
                  href="#"
